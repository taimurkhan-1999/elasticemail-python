...
**event_type** | [**EventType**](EventType.md) |  | [optional] [default to EventType.SUBMISSION]
**event_date** | **datetime** | Creation date | [optional] 
**channel_name** | **str** | Name of selected channel. | [optional] 
**message_category** | [**MessageCategory**](MessageCategory.md) |  | [optional] [default to MessageCategory.UNKNOWN]
**next_try_on** | **datetime** | Date of next try | [optional] 
**message** | **str** | Error message if sending has failed (FailedAttempt or Bounce) | [optional] 
