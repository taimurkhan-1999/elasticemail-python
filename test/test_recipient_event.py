...
class TestRecipientEvent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RecipientEvent:
        """Test RecipientEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecipientEvent`
        """
        ...
        if include_optional:
            return RecipientEvent(
                ...
                next_try_on = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                message = '',
                ip_address = '',
                pool_name = ''
            )
