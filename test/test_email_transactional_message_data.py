...
class TestEmailTransactionalMessageData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EmailTransactionalMessageData:
        """Test EmailTransactionalMessageData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailTransactionalMessageData`
        """
        model = EmailTransactionalMessageData()
        if include_optional:
            return EmailTransactionalMessageData(
                recipients = ElasticEmail.models.transactional_recipient.TransactionalRecipient(
                    to = [
                        ''
                        ], 
                    cc = [
