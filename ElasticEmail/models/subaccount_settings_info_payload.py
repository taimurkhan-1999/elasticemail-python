...
class SubaccountSettingsInfoPayload(BaseModel):
    """
    SubAccount settings
    """ # noqa: E501
    email: Optional[SubaccountEmailSettingsPayload] = Field(default=None, alias="Email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Email": SubaccountEmailSettingsPayload.from_dict(obj["Email"]) if obj.get("Email") is not None else None
        })
        return _obj
