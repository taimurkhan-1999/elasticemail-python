...
class EmailMessageData(BaseModel):
    ...
    Email data
    """ # noqa: E501
    recipients: List[EmailRecipient] = Field(description="List of recipients", alias="Recipients")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Recipients": [EmailRecipient.from_dict(_item) for _item in obj["Recipients"]] if obj.get("Recipients") is not None else None,
