...
class ChannelLogStatusSummary(BaseModel):
    """
    Summary of channel log status
    """ # noqa: E501
    channel_name: Optional[StrictStr] = Field(default=None, description="Channel name", alias="ChannelName")
    ...
    __properties: ClassVar[List[str]] = ["ChannelName", "Recipients", "EmailTotal", "SmsTotal", "Delivered", "Bounced", "InProgress", "Opened", "Clicked", "Unsubscribed", "Complaints", "Inbound", "ManualCancel", "NotDelivered"]
