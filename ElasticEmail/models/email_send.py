...
class EmailSend(BaseModel):
    ...
    message_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this email.", alias="MessageID")
    __properties: ClassVar[List[str]] = ["TransactionID", "MessageID"]
