...
class DomainPayload(BaseModel):
    ...
    set_as_default: Optional[StrictBool] = Field(default=None, alias="SetAsDefault")
    __properties: ClassVar[List[str]] = ["Domain", "SetAsDefault"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "SetAsDefault": obj.get("SetAsDefault")
        })
        return _obj
