...
class DomainData(BaseModel):
    ...
    """ # noqa: E501
    validation_log: Optional[StrictStr] = Field(default=None, description="Domain validation results - when domain has been running through validation process", alias="ValidationLog")
    ...
    __properties: ClassVar[List[str]] = ["ValidationLog", "Domain", "DefaultDomain", "Spf", "Dkim", "MX", "DMARC", "IsRewriteDomainValid", "Verify", "Type", "TrackingStatus", "CertificateStatus", "CertificateValidationError", "TrackingTypeUserRequest", "VERP", "CustomBouncesDomain", "IsCustomBouncesDomainDefault", "IsMarkedForDeletion", "Ownership"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ValidationLog": obj.get("ValidationLog"),
