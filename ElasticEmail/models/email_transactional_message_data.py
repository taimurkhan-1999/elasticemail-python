...
class EmailTransactionalMessageData(BaseModel):
    """
    Email data
    """ # noqa: E501
    recipients: TransactionalRecipient = Field(alias="Recipients")
    content: EmailContent = Field(alias="Content")
    options: Optional[Options] = Field(default=None, alias="Options")
    __properties: ClassVar[List[str]] = ["Recipients", "Content", "Options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Recipients": TransactionalRecipient.from_dict(obj["Recipients"]) if obj.get("Recipients") is not None else None,
