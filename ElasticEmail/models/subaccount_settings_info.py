...
class SubaccountSettingsInfo(BaseModel):
    """
    SubAccount settings
    """ # noqa: E501
    email: Optional[SubaccountEmailSettings] = Field(default=None, alias="Email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Email": SubaccountEmailSettings.from_dict(obj["Email"]) if obj.get("Email") is not None else None
        })
        return _obj
