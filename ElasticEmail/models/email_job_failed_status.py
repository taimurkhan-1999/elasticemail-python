...
class EmailJobFailedStatus(BaseModel):
    """
    ...
    error_code: Optional[StrictInt] = Field(default=None, description="RFC Error code", alias="ErrorCode")
    category: Optional[StrictStr] = Field(default=None, alias="Category")
    __properties: ClassVar[List[str]] = ["Address", "Error", "ErrorCode", "Category"]
