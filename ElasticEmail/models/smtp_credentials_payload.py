...
class SmtpCredentialsPayload(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Credential for ease of reference. It must be a valid email address.", alias="Name")
    ...
    subaccount: Optional[StrictStr] = Field(default=None, description="Email of the subaccount for which this SmtpCredential should be created", alias="Subaccount")
    __properties: ClassVar[List[str]] = ["Name", "Expires", "RestrictAccessToIPRange", "Subaccount"]
