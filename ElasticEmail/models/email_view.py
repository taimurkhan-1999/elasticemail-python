...
class EmailView(BaseModel):
    ...
    """ # noqa: E501
    body: Optional[StrictStr] = Field(default=None, description="Body (HTML, otherwise plain text) of email", alias="Body")
    subject: Optional[StrictStr] = Field(default=None, description="Default subject of email.", alias="Subject")
    var_from: Optional[StrictStr] = Field(default=None, description="From email address", alias="From")
    __properties: ClassVar[List[str]] = ["Body", "Subject", "From"]
