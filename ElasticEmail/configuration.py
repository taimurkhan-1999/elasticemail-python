...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "ApiKeyAuthCustomBranding": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = ElasticEmail.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.elasticemail.com/v4" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ElasticEmail")
